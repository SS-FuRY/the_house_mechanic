                ...
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                            <h3 className="font-bold text-4xl mb-4">The House Mechanic</h3>
                            <div className='text-md font-medium text-gray-600'>
                                <h5>Greater Sudbury</h5>
                                <p>Ontario</p>
                                <p>Canada </p>
                                <p>Ogun State.</p>
                            </div>
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-1 ml-7 mx-auto">
                        ...
                        <li className="mb-2">
                            <HashLink smooth to="/#hero" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">About</HashLink>
                        </li>
                        <li className="mb-2">
                        ...
                        <li className="mb-2">
                            <HashLink  smooth to="/#contact" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Contact</HashLink>
                        </li>                            
                        </ul>
                    </div>
                    ...
                    <div className='mt-5'>
                                ...
                                <p className="text-blue-900 font-extrabold">thehousemechanicssudbury@gmail.com</p>
                            </div>
                        <br />    
