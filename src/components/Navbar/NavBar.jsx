...
import onlyLogo from '../../images/HouseLogo.png';
...
const NavBar = () => {
    ...
    return (
        <nav className={`fixed top-0 w-full z-30 transition duration-300 ease-in-out mb-16 ${!top && 'backdrop-blur-sm bg-white shadow-lg'}`}>
            <div className="flex flex-row justify-between items-center py-2">
            <div className="flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold">
    <HashLink smooth to="/#hero" className="flex items-center">
        <img alt="card img" className="rounded-t w-16 h-14 mr-2" src={onlyLogo} />
        <h1 className="font-extrabold text-2xl text-blue-900">The House Mechanic</h1>
    </HashLink>
</div>
